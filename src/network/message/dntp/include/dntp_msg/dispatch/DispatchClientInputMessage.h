...
#include "dntp_msg/input/ClientInputMessages.h"
...
/// @note Defined in dntp_msg/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<dntp_msg::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<dntp_msg::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref dntp_msg::options::DefaultOptions.
/// @headerfile dntp_msg/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(dntp_msg::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(dntp_msg::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return dntp_msg::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(dntp_msg::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(dntp_msg::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return dntp_msg::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<dntp_msg::options::DefaultOptions>;
