...
#include "dntp_msg/input/AllMessages.h"
...
/// @note Defined in dntp_msg/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<dntp_msg::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<dntp_msg::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref dntp_msg::options::DefaultOptions.
/// @headerfile dntp_msg/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(dntp_msg::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(dntp_msg::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return dntp_msg::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(dntp_msg::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(dntp_msg::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return dntp_msg::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<dntp_msg::options::DefaultOptions>;
