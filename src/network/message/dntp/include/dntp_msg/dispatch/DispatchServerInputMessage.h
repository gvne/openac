...
#include "dntp_msg/input/ServerInputMessages.h"
...
///     like @ref dntp_msg::options::DefaultOptions.
...
///     @code
///     using MyInterface = dntp_msg::MessageInterface<...>;
///     using MySomeMessage = SomeMessage<MyInterface, dntp_msg::options::DefaultOptions>;
///     using MySomeOtherMessage = SomeOtherMessage<MyInterface, dntp_msg::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in dntp_msg/dispatch/DispatchServerInputMessage.h
...
///     dntp_msg::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<dntp_msg::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<dntp_msg::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref dntp_msg::options::DefaultOptions.
/// @headerfile dntp_msg/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(dntp_msg::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(dntp_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return dntp_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(dntp_msg::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(dntp_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return dntp_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref dntp_msg::options::DefaultOptions as template parameter.
/// @note Defined in dntp_msg/dispatch/DispatchServerInputMessage.h
using ServerInputMsgDispatcherDefaultOptions =
    ServerInputMsgDispatcher<dntp_msg::options::DefaultOptions>;
