...
#include "oac_msg/input/ServerInputMessages.h"
...
/// @note Defined in oac_msg/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<oac_msg::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<oac_msg::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref oac_msg::options::DefaultOptions.
/// @headerfile oac_msg/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(oac_msg::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(oac_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return oac_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(oac_msg::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(oac_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return oac_msg::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ServerInputMsgDispatcherDefaultOptions =
    ServerInputMsgDispatcher<oac_msg::options::DefaultOptions>;
